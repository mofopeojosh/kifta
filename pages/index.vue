  ...
  <main class="w-full">
    ...
    <div class="main">
        ...
        <section class="container app-intro grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="mx-auto mt-10">
            ...
            <nuxt-link to="/sectors/defense" class="sectors-card w-64">
              <div class="mr-3">
                <img src="/images/defense.svg" class="inline" width="18">
              </div>
              <span class="text-lg">Defense</span>
            </nuxt-link>
          </div>
        </section>
      </div>
      ...
      <div class="bg-white bg-opacity-75 py-10 padded">
        <section class="container produce">
          <h2 class="text-4xl text-center mb-9">
            Our Products
          </h2>
          <client-only>
            <ProductsView :max-display="4" :more-btn="true" :featured-only="true"></ProductsView>
          </client-only>
        </section>
